                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 256),
                        Department = c.String(nullable: false, maxLength: 256),
                        Skype = c.String(nullable: false, maxLength: 256),
                        Mobile = c.String(nullable: false, maxLength: 256),
                        Yahoo = c.String(nullable: false, maxLength: 256),
                        Facebook = c.String(nullable: false, maxLength: 256),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
